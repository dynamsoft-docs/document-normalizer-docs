...
`fileFullPath`: A string defining the file path. It supports BMP, TIFF, JPG, PNG files.  
...
The normlized image result. Refer [`NormalizedImageResult`](normalzied-image-result.md)
