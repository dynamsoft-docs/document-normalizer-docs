...
## Document Normalizer Task Setting
 ...
 | [`CornerAngleRangeArray`]({{ site.parameters_reference }}document-normalizer-task-settings/corner-angle-range-array.html) | Defines the range of angles (in degrees) of the extracted corners. |
